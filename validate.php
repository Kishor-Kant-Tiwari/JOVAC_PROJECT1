...
while(!feof($file))
{
  ...
  if ($str_arr[1]==$psw and $str_arr[2]==$email)
  {
  	$rem=$str_arr[3];
		...
		echo "<h3>Your Course Name is</h3>".$str_arr[4]."<br>";
		echo "<h3>Your Course Application number is</h3>".$str_arr[3]."<br>";
		echo "<h3>Your course starting date is</h3>".$str_arr[5]."<br>";
